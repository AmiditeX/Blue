/********************************************************************************
** Form generated from reading UI file 'databasesettings.ui'
**
...
#ifndef UI_DATABASESETTINGS_H
#define UI_DATABASESETTINGS_H
...
public:
    ...
    void setupUi(QWidget *DatabaseSettings)
    {
        if (DatabaseSettings->objectName().isEmpty())
            DatabaseSettings->setObjectName(QStringLiteral("DatabaseSettings"));
        DatabaseSettings->resize(1080, 750);
        DatabaseSettings->setStyleSheet(QStringLiteral("background-color: rgb(44, 44, 52);"));
        openKey = new QPushButton(DatabaseSettings);
...
"}"));
        label_2 = new QLabel(DatabaseSettings);
...
"font-weight: bold"));
        label_3 = new QLabel(DatabaseSettings);
...
"background-color: rgb(93, 127, 247);\n"
"}"));
        open = new QPushButton(DatabaseSettings);
...
"background-color: rgb(93, 127, 247);\n"
"}"));
        database = new QLineEdit(DatabaseSettings);
...
"border-radius:0px"));
        ...
        key = new QLineEdit(DatabaseSettings);
...
"border-radius:0px"));
        ...
        label_4 = new QLabel(DatabaseSettings);
...
"font: 8pt \"DejaVu Sans\";"));
        stretchTime = new QSpinBox(DatabaseSettings);
...
"}"));
        ...
        label_7 = new QLabel(DatabaseSettings);
...
"font: 8pt \"DejaVu Sans\";"));
        ...
        retranslateUi(DatabaseSettings);

        QMetaObject::connectSlotsByName(DatabaseSettings);
    } // setupUi

    void retranslateUi(QWidget *DatabaseSettings)
    {
        DatabaseSettings->setWindowTitle(QApplication::translate("DatabaseSettings", "Form", nullptr));
        openKey->setText(QApplication::translate("DatabaseSettings", "Open", nullptr));
        label_2->setText(QApplication::translate("DatabaseSettings", "   Blue", nullptr));
        label_3->setText(QApplication::translate("DatabaseSettings", "                    Edit database", nullptr));
        label->setText(QString());
        close->setText(QApplication::translate("DatabaseSettings", "Close", nullptr));
        ok->setText(QApplication::translate("DatabaseSettings", "Modify", nullptr));
        open->setText(QApplication::translate("DatabaseSettings", "Open", nullptr));
        database->setText(QString());
        database->setPlaceholderText(QApplication::translate("DatabaseSettings", "Path of the database..", nullptr));
        key->setText(QString());
        key->setPlaceholderText(QApplication::translate("DatabaseSettings", "Path to key..", nullptr));
        label_4->setText(QApplication::translate("DatabaseSettings", "You can add any file as a key, as long as it is never modified and not empty\n"
"It is needed for decryption and has to be provided to open the database.", nullptr));
        stretchTime->setSuffix(QApplication::translate("DatabaseSettings", " sec", nullptr));
        label_5->setText(QApplication::translate("DatabaseSettings", "Stretch time (time taken to open the database)\n"
"Prevents effectiveness of bruteforce attacks ", nullptr));
        label_6->setText(QApplication::translate("DatabaseSettings", "Number of iterations made to open the database\n"
...
"Don't use this parameter if you're not familiar with it", nullptr));
        ...
        label_7->setText(QApplication::translate("DatabaseSettings", "or", nullptr));
    } // retranslateUi

};

namespace Ui {
    class DatabaseSettings: public Ui_DatabaseSettings {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DATABASESETTINGS_H
